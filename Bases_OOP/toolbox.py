...
# Instantiate objects
ma_boite = ToolBox()
mon_tournevis = Screwdriver()
mon_marteau = Hammer()

# Add tools to toolbox
ma_boite.add_tool(mon_tournevis)
ma_boite.add_tool(mon_marteau)
print(f"Tools in the toolbox: {ma_boite.tools}\n")

# Tighten a screw
ma_vis = Screw()
print(f"Before: {ma_vis}")
mon_tournevis.tighten(ma_vis)
print(f"After: {ma_vis}\n")

# Hammer a nail
mon_clou = Nail()
print(f"Before: {mon_clou}")
mon_marteau.hammer_in(mon_clou)
print(f"After: {mon_clou}")